...
| 07 | Troca de turno com aceite duplo e trilha formal | Pendente | Alta | Requisito do produto ainda nao implementado de ponta a ponta. |
| 08 | Escala, falta, atraso e cobertura | Pendente | Alta | Ainda nao existe modulo operacional de jornada completo. |
...
| 17 | Auditoria de acoes criticas | Pendente | Alta | Necessario para operacao, cliente e compliance. |
