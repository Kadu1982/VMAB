...
| 16 | Notificacoes em tempo real | Em andamento | Media | O painel web consome SSE real e o morador ja recebe push Expo no app unico; ainda faltam notificacao formal para cliente e push operacional mais amplo no fluxo do colaborador. |
