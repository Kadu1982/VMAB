...
| 16 | Notificacoes em tempo real | Em andamento | Media | O painel web consome SSE real, o morador recebe push Expo e o colaborador recebe alerta local ao detectar mudanca relevante na fila; ainda faltam notificacao formal para cliente e push operacional remoto do fluxo da ronda. |
