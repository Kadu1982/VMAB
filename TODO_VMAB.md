...
| 19 | LGPD e politicas de retencao | Em andamento | Alta | O backend e o painel agora cobrem pedido, andamento, notificacao registrada, exportacao JSON, anonimização e retencao tecnica; o que ainda falta nao e codigo trivial, e sim revisao juridica formal e integracao de notificacao real para fora da plataforma. |
