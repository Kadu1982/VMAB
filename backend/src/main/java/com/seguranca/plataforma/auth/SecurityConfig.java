    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Health probes ficam publicos para Docker, Caddy e verificacao externa.
                        .requestMatchers("/actuator/health", "/actuator/health/**").permitAll()
                        // Informacoes administrativas continuam protegidas por perfil.
                        .requestMatchers("/actuator/info", "/actuator/metrics", "/actuator/metrics/**", "/actuator/prometheus", "/actuator/loggers", "/actuator/loggers/**").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/incidents/*/dispatch/me", "/api/incidents/*/onsite/me", "/api/incidents/*/close/me").hasRole("RONDA")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/shifts/*/handoff-accept", "/api/shifts/*/handoff-reject").hasRole("RONDA")
                        .requestMatchers(HttpMethod.POST, "/api/shifts/*/supervision").hasAnyRole("SUPERVISOR", "ADMIN")
